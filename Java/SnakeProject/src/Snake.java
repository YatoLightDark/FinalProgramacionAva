import javax.swing.*; //se usa para darle dimension a la ventana
import java.awt.*;
import java.awt.Color;
import java.awt.event.KeyEvent;
// nos da el tamaño de las ventanas

 // tener el punto en el plano
...
public class Snake extends JFrame {
    ...
    public class ImagenSnake extends JPanel {
        public void paintComponent(Graphics g) {
            ...
            if(gameOver) {
                g.setColor(new Color(21, 13, 13));
            } else {
                g.setColor(new Color(14, 8, 8));
            }
